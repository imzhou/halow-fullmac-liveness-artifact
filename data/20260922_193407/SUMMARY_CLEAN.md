...
- Combined with prior 5-trial two-peer suite (2 fail / 3 heal): stock **11/25** fail vs LHR **0/25**, p ≈ **1.2e-4**.

## E4 (this run discarded)

- **All 20 rounds** baseline `watch=0` (oneshot watch not observed / not running).
- Stock “heals” in 3–7s with watch still 0 → **another path** brings `hg0` UP (not the oneshot watch hypothesis).
